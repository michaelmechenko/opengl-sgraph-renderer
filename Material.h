...
public:
  ...
  void setEmission(const glm::vec4 &v) { emission = glm::vec4(v); }
  ...
  void setAmbient(const glm::vec4 &v) { ambient = glm::vec4(v); }
  ...
  void setDiffuse(const glm::vec4 &v) { diffuse = glm::vec4(v); }
  ...
  void setSpecular(const glm::vec4 &v) { specular = glm::vec4(v); }

  float getShininess() const { return shininess; }
  void setShininess(float r) { shininess = r; }
